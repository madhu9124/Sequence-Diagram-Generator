...
// Program to extract usefull information from execution trace inorder to generate UML textual notation for sequence diagram.

package dynamic_sequence_diagram;
...
public class generate_sequence_diagram 
{
